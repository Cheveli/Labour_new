...
export async function generateAndEmailWeeklyReport(config: ReportConfig) {
  ...
  doc.text('FOR ' + COMPANY_DETAILS.name, 172.5, finalYPage1 + 3.5, { align: 'center' })
  doc.setFont('times', 'italic'); doc.setFontSize(9)
  doc.text(COMPANY_DETAILS.contractorRaw, 172.5, finalYPage1 + 9.5, { align: 'center' })
  ...
  doc.setTextColor(...PDF_COLORS.NAVY)
  doc.setFontSize(8)
  doc.text('FOR ' + COMPANY_DETAILS.name, 167, sigY2, { align: 'center' })

  doc.setFont('times', 'italic')
  doc.setFontSize(11)
  doc.text(COMPANY_DETAILS.contractorRaw, 167, sigY2 + 8, { align: 'center' })
